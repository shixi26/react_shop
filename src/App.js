  ...
  return (
    <div>
      ...
      <Navbar bg="light" data-bs-theme="light">
        <Container>
          ...
          <Nav className="me-auto">
            ...
            <Nav.Link href="react_shop/bestSeller">BestSeller</Nav.Link>
            <Nav.Link href="react_shop/new">New</Nav.Link>
            <Nav.Link href="react_shop/steadySeller">SteadySeller</Nav.Link>
            <Nav.Link onClick={()=>(navigate('react_shop/detail'))}>detail</Nav.Link>
          </Nav>
        </Container>
      </Navbar>
      ...
      <Routes>
        ...
        <Route path="react_shop/detail" element={<Detail books={books}/>}/> 
        <Route path="*" element={<div>404</div>}/> 
        <Route path="react_shop/about" element={<About/>}>
          <Route path="member" element={<div>멤버</div>}/>
          <Route path="location" element={<About/>}/>
        </Route>
        <Route path="react_shop/event" element={<Event/>}>
